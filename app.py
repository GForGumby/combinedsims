...
st.text("Navigate to the Projections page, upload your draft results. Upload your projections. Must be in the format of player_name, projection in column A and B of your csv")
